      ...
      if (selectedIndex >= 0) {
        ...
        setTimeout(() => {
          ...
          if (element && dropdownRef.current) {
            ...
            const scrollTop =
              elementTop - dropdownHeight / 2 + elementHeight / 2;
  ...
  return (
    ...
    >
      ...
      {isOpen && !disabled && (
        <div
          ref={dropdownRef}
          className={`absolute z-100 w-full mt-1 bg-white border border-slate-200 rounded-lg shadow-lg ${maxHeight} overflow-auto`}
        >
